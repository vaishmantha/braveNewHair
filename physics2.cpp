//  NOTE: NOT INTEGRATED INTO PIPELINE
 /*
 ...
 */
 ...
 void computeAcceleration(struct world * jello, struct point a[numPoints])
 {
   ...
   stretchStringForce(jello); // Equivalent of computeStructuralSpringForces
 ...
 void stretchStringForce(struct world *jello) {
    ...
    for (int i = 0; i < (numPoints - 1); i++) {
        ...
        // TODO: add p_init to jello struct
        struct point edge;
        ...
        pDIFFERENCE(jello->p_init[i+1], jello->p_init[i], rest_edge);
 ...
 void gravity(struct world *jello, struct point forces[numPoints]) {
